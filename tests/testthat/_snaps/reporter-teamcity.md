# reporter basics work
    ...
    ##teamcity[testStarted name='expectation 1']
    ##teamcity[testFailed name='expectation 1' message='FALSE is not TRUE' details='|n`actual`:   FALSE|n`expected`: TRUE |nBacktrace:|n    x|n 1. \-f() at reporters/tests.R:17:2|n 2.   \-testthat::expect_true(FALSE) at reporters/tests.R:16:7']
    ##teamcity[testFinished name='expectation 1']
    ...
    ##teamcity[testStarted name='expectation 1']
    ##teamcity[testFailed name='expectation 1' message='Error in `h()`: !' details='Backtrace:|n    x|n 1. \-f() at reporters/tests.R:31:2|n 2.   \-g() at reporters/tests.R:27:7|n 3.     \-h() at reporters/tests.R:28:7']
    ##teamcity[testFinished name='expectation 1']
