...
To run code before any test is run, you can create a file called `tests/testthat/helper.R`. If the code in this file needs clean up, you can use the special `teardown_env()` in `tests/testthat/setup.R`:
