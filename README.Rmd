...
[![Codecov test coverage](https://codecov.io/gh/r-lib/testthat/branch/master/graph/badge.svg)](https://app.codecov.io/gh/r-lib/testthat?branch=main)
<!-- badges: end -->
...
If you're not familiar with testthat, the [testing chapter](https://r-pkgs.org/tests.html) in [R packages](https://r-pkgs.org) gives a good overview, along with workflow advice and concrete examples.
