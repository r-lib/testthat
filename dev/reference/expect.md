...
[`pass()`](https://testthat.r-lib.org/dev/reference/fail.md) and
[`fail()`](https://testthat.r-lib.org/dev/reference/fail.md). See
...
- trace_env:
  ...
  calling [`fail()`](https://testthat.r-lib.org/dev/reference/fail.md)
  from a helper function; see
  [`vignette("custom-expectation")`](https://testthat.r-lib.org/dev/articles/custom-expectation.md)
  for details.
...
[`succeed()`](https://testthat.r-lib.org/dev/reference/succeed.md) or
[`fail()`](https://testthat.r-lib.org/dev/reference/fail.md). with a
