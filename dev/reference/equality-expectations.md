...
- ...:
  ...
  **2e**: passed on to
  [`compare()`](https://testthat.r-lib.org/dev/reference/compare.md)/[`identical()`](https://rdrr.io/r/base/identical.html).
...
- tolerance:
  ...
  **2e**: passed on to
  [`compare()`](https://testthat.r-lib.org/dev/reference/compare.md), if
...
- [`expect_setequal()`](https://testthat.r-lib.org/dev/reference/expect_setequal.md)/[`expect_mapequal()`](https://testthat.r-lib.org/dev/reference/expect_setequal.md)
