...
- [`skip_on_cran()`](https://testthat.r-lib.org/dev/reference/skip.md)
  ...
  skips tests on Bioconductor. This is useful for slow tests and tests
  that occasionally fail for reasons outside of your control.

- [`skip_on_os()`](https://testthat.r-lib.org/dev/reference/skip.md)
  allows you to skip tests on a specific operating system. Generally,
  you should strive to avoid this as much as possible (so your code
  works the same on all platforms), but sometimes it’s just not
  possible.

- [`skip_on_ci()`](https://testthat.r-lib.org/dev/reference/skip.md)
  skips tests on most CI platforms (e.g., GitHub Actions).

- [`skip_on_covr()`](https://testthat.r-lib.org/dev/reference/skip.md)
  skips tests during code coverage.
...
[`skip_if()`](https://testthat.r-lib.org/dev/reference/skip.md) or
...
[`skip()`](https://testthat.r-lib.org/dev/reference/skip.md) directly
into a package function. For example, take a look at
...
[`testthat::skip()`](https://testthat.r-lib.org/dev/reference/skip.md).
But
[`testthat::skip()`](https://testthat.r-lib.org/dev/reference/skip.md)
is only executed during a test run, which means that testthat is
installed.
