...
for [`test_dir()`](https://testthat.r-lib.org/reference/test_dir.md),
[`test_file()`](https://testthat.r-lib.org/reference/test_file.md), and
[`test_package()`](https://testthat.r-lib.org/reference/test_package.md):

- `default_reporter()` returns the default reporter for
  [`test_dir()`](https://testthat.r-lib.org/reference/test_dir.md). If
  `parallel` is `TRUE`, it uses
...
- `default_compact_reporter()` returns the default reporter for
  [`test_file()`](https://testthat.r-lib.org/reference/test_file.md). It
  defaults to
...
[LlmReporter](https://testthat.r-lib.org/reference/LlmReporter.md) if it
appears that the tests are being run by a coding agent.
