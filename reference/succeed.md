...
[`pass()`](https://testthat.r-lib.org/reference/fail.md) that exists for
backwards compatibility. You should now use
[`pass()`](https://testthat.r-lib.org/reference/fail.md) instead.
